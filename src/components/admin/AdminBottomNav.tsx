...
import { LayoutDashboard, Package, Users, Image as ImageIcon, Settings } from "lucide-react";
...
export function AdminBottomNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-5 border-t border-border bg-white shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.08)] md:hidden"
